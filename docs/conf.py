...
src_paths = [
    os.path.abspath('src/mercury-agent'),
...
project = 'Mercury'
copyright = '2017, Jared Rodriguez'
...
latex_documents = [
    (master_doc, 'Mercury.tex', 'Mercury Documentation',
     'Jared Rodriguez', 'manual'),
]
...
man_pages = [
    (master_doc, 'mercury', 'Mercury Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Mercury', 'Mercury Documentation',
     author, 'Mercury', 'One line description of project.',
     'Miscellaneous'),
]
